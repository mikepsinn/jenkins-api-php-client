...
namespace App\DevOps\JenkinsAPI\Client;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'http://quantimodo2.asuscomm.com:8082';
    ...
    public static function toDebugReport(): string{
        $report  = 'PHP SDK (App\DevOps\JenkinsAPI\Client) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.1.1' . PHP_EOL;
    ...
    public function getHostSettings(): array{
        return [
            [
                "url" => "http://quantimodo2.asuscomm.com:8082",
